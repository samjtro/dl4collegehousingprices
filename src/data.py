...
class preprocess:
	...
	def __realtor__():
		RDC_inventory = pd.read_csv('https://econdata.s3-us-west-2.amazonaws.com/Reports/Core/RDC_Inventory_Core_Metrics_Zip_History.csv')
		...
		df.to_csv('data/realtor.csv',index=False)
