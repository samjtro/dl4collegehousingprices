...
# next few lines reads in all RDC data and the final_204.csv file we created. RDC files can be downloaded seperately (see the readme)
...
for x in range(len(final_204)):
	...
	for a in range(len(RDC_inventory)):
		...
		# all of the above iterates through final_204 and RDC_inventory in order to fetch zip codes from both. if they match, the data is appended to each array.
